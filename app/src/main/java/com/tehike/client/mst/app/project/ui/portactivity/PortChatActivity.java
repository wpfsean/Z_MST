...
public class PortChatActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initDb() {
        if (db == null) {
            DatabaseHelper databaseHelper = new DatabaseHelper(PortChatActivity.this);
    ...
    private void initParamater() {
        ...
        //取出本地缓存 的数据
        String dataSources = (String) SharedPreferencesUtils.getObject(PortChatActivity.this, "sip_resources", "");
